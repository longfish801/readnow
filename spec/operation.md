...
1. 追加感想履歴ファイルを作成します。
2. 追加感想履歴ファイルから追加感想最新ファイルを生成します。
3. 追加感想最新ファイルを原稿に反映します。
4. 原稿ファイルから公開原稿ファイルを生成します。
5. ローカルのWebサーバでサイト表示を確認します。
6. 公開します。

　新しく追加感想履歴ファイルを作成し、テキスト形式で感想を記述します。  
　これをtpac形式に変換して追加感想最新ファイルを生成します。

　追加感想最新ファイルにISBNを追加します。  
　エディタで開いて種々の編集をします。

　既存の感想すべてとマスタを tpac形式で保持しているのが原稿です。  
　追加感想最新ファイルの内容を原稿に反映します。
...
　追加感想フォルダにシステム日付でテキストファイルを作成してください。  
...
* “『”と“』”の間にタイトルを記述します。
	- 巻数がある場合はタイトルの直後に区切り文字無しで記述してください。
...
　追加感想最新ファイル latest.tpacファイルをエディタで開いてください。  
　必要に応じて編集してください。  
　たとえば以下に留意してください。
...
　マスタファイルについて、新たに追加した著者名についてルビを正しく取得できているか確認してください。  
